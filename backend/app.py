...
try:
    from backend.file.file_crawl_stage_lab_router import router as file_crawl_stage_lab_router

    app.include_router(file_crawl_stage_lab_router)
    app.include_router(file_crawl_stage_lab_router, prefix="/Ai_Pro_filecrawler")
    logger.info("[FileCrawlStageLab] routes included")
except Exception as exc:
